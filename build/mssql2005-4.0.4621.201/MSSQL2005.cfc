<cfcomponent extends="types.Driver" output="false" implements="types.IDatasource">
	<cfset this.className="com.microsoft.sqlserver.jdbc.SQLServerDriver">
	...
	<cffunction name="getName" returntype="string" output="no"
		...
		<cfreturn "Microsoft SQL Server 2005 (JDBC4 - Vendor Microsoft)">
	</cffunction>
	
	<cffunction name="getDescription" returntype="string" output="no"
		hint="returns description for the driver">
		<cfreturn "Microsoft SQL Server 2005 Driver from Microsoft. This is a Type 4 JDBC driver that provides database connectivity through the standard JDBC application program interfaces (APIs) available in Java Platform, Enterprise Edition 5, 6, 7, and 8.">
	</cffunction>
